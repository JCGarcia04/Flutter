...
class SudokuHard extends StatefulWidget {
  const SudokuHard({super.key});
  _SudokuHardState createState() => _SudokuHardState();
}

class _SudokuHardState extends State<SudokuHard> {
  // variable
